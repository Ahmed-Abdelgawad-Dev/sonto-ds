...
<template>
  <footer class="relative bg-darker border-t border-white/5 overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      ></div>
      <div
        class="absolute -bottom-40 -left-40 w-80 h-80 bg-secondary/5 rounded-full blur-3xl"
      ></div>
    </div>

    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-8">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
        ...
        <div class="lg:col-span-2">
          ...
          <div class="flex space-x-3">
            ...
            <a
              href="#"
              class="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 hover:bg-secondary/20 border border-white/5 hover:border-secondary/30 text-gray-400 hover:text-secondary transition-all duration-300"
            >
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path
            ...
            <a
              href="#"
              class="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 hover:bg-accent/20 border border-white/5 hover:border-accent/30 text-gray-400 hover:text-accent transition-all duration-300"
            >
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path
            ...
            <a
              href="#"
              class="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 hover:bg-red-500/20 border border-white/5 hover:border-red-500/30 text-gray-400 hover:text-red-500 transition-all duration-300"
            >
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path
        ...
        >
          ...
          <ul class="space-y-3">
            <li v-for="link in links" :key="link.name">
              <router-link
                :to="link.path"
                class="text-gray-400 hover:text-primary text-sm transition-colors duration-200"
              >
                {{ link.name }}
              </router-link>
            </li>
